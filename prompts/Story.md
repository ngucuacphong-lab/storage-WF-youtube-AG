...
Every story should naturally progress through the following stages:
...
The progression should feel continuous and logical.
...
Every scene must naturally connect to the previous one.
...
Avoid abrupt jumps unless intentionally used for dramatic effect.
...
Every major event should influence future events.

Avoid random developments.

Avoid introducing information without purpose.

The story should behave like a chain reaction.
...
Each scene should provide at least one of the following:
...
Never create scenes that only exist to increase scene count.

Avoid explaining too many independent ideas within a single scene.
...
Curiosity should continuously increase throughout the story.

Avoid answering every question immediately.

Reveal information progressively.

Whenever one question is answered, naturally introduce another.

The audience should always have a reason to continue watching.

---

## Emotional Curve

The emotional intensity should evolve naturally.
...
Never allow viewer interest to plateau.
...
If discussing speculation:

- Build from existing science.
- Explain assumptions logically.
- Separate speculation from established facts.
...
Avoid spending too much time on obvious ideas.
...
Summarize the overall consequence.

Leave the audience with a memorable final thought.
...
Before the story is considered complete, verify:
...
- Scientific reasoning
- Fast but understandable pacing
- Memorable ending
- No filler
- No repeated ideas
